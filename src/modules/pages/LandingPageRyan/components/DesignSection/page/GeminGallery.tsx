  ...
  return (
    ...
    <div className="relative bg-gray-200 w-[100]  overflow-hidden text-left text-[3rem] text-mediumblue-300">
      <Header />
        ...
        <h1 className="text-[3rem] text-mediumblue-300">Gemini Engenharia</h1>
        <h3 className="text-[1rem] text-gray-300">• Feito por Ryan na Agência Layout •</h3><br />

                
        <div className="flex flex-col py-[0rem] px-[6.25rem] items-start justify-start gap-[2.5rem] text-center text-[0.75rem] text-darkslateblue-200">
            {renderGallery()}
        </div>
        {selectedImage && (
